...
const ActionDropdown = (params: TransactionInterface) => {
      ...
      <Modal open={openModalDetail} onClose={() => setOpenModalDetail(false)}>
        ...
        >
          <Grid container spacing={2} width={'100%'} alignItems={'center'}>
            ...
            <Grid item xs={8.6}>
              <Typography variant="body2">{params?.name || ''}</Typography>
            </Grid>
          </Grid>
          ...
          <Grid container spacing={2} width={'100%'} my={1} alignItems={'center'}>
            ...
            <Grid item xs={8.6}>
              <Typography variant="body2">{params.category?.name || '-'}</Typography>
            </Grid>
          </Grid>
          <Grid container spacing={2} width={'100%'} my={1} alignItems={'center'}>
            <Grid item xs={2.4}>
            ...
            <Grid item xs={8.6}>
              <Typography variant="body2">
                {params.source?.account_number ? params.source.account_number : '-'}
              </Typography>
            </Grid>
          </Grid>
          <Grid container spacing={2} width={'100%'} my={1} alignItems={'center'}>
            ...
            <Grid item xs={8.6}>
              <Typography
                color={params?.type === 'expense' ? 'error.main' : 'success.main'}
                variant="body2"
              >
                {currencyFormat(params?.amount)}
              </Typography>
            </Grid>
          </Grid>
          <Grid container spacing={2} width={'100%'} my={1} alignItems={'center'}>
            ...
            <Grid item xs={8.6}>
              <Typography variant="body2">{params?.type}</Typography>
            </Grid>
          </Grid>
          <Grid container spacing={2} width={'100%'} my={1} alignItems={'center'}>
            <Grid item xs={2.4}>
            ...
            <Grid item xs={8.6}>
              <Typography variant="body2">
                {params.source?.type ? params.source.type : '-'}
              </Typography>
            </Grid>
          </Grid>
          <Grid container spacing={2} width={'100%'} my={1} alignItems={'start'}>
            <Grid item xs={2.4}>
            ...
            <Grid item xs={8.6}>
              <img
                src={`${import.meta.env.VITE_STORAGE_BASE_URL}/${params?.attachment}`}
                alt={params?.attachment}
                width={'80%'}
                height={'100%'}
              />
            </Grid>
